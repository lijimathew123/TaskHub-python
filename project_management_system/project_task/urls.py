...
urlpatterns = [
    ...
    path('add_task_note/<int:employee_id>/<int:task_id>/',views.add_task_note, name='add_task_note'),
    path('view_task_notes/<int:task_id>/', views.view_task_notes, name='view_task_notes'),
    path('view_team_member_note/<int:group_id>/', views.view_team_member_note, name='view_team_member_note'),
